...
**To add this library to your project, add** `#require "bullwinkle.class.nut:2.3.3"` **to the top of your agent and device code.**
...
#require "Bullwinkle.class.nut:2.3.3"
